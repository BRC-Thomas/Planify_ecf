  ...
  return (
    ...
    <div className="lg:w-1/3 px-2 mb-4 md:mb-2 relative">
      <div>
        ...
        <p className="text-sm leading-6 text-gray-900 absolute top-2 right-5">{task.category}</p>
        {task.isDone ? (
            <p className="pb-1 text-xs leading-5 text-gray-500 mb-2 absolute top-6 right-5">
