        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Une fois votre compte supprimé, toutes ses ressources et données seront définitivement supprimées. Avant la
                    suppression de votre compte, veuillez télécharger les données ou informations que vous souhaitez conserver.
                </p>
            </header>

            <DangerButton onClick={confirmUserDeletion}>Supprimer le compte ⚠️</DangerButton>
